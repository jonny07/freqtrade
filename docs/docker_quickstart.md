...
Uncommend the lines and add your IP adress in the following format (like 192.168.2.67:8080:8080) to the docker-compose.yml:
'''bash
    ports:
...
'''
You can access the UI by typing yourIPadress:8080 in your browser
